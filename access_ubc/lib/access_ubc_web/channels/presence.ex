defmodule AccessUbcWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule AccessUbc.MyChannel do
        use AccessUbcWeb, :channel
        alias AccessUbcWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :access_ubc,
                        pubsub_server: AccessUbc.PubSub
end
